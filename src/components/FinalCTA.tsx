  ...
  return (
    <section className="py-24 relative z-10 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12 relative">
        ...
        <div 
          className="glass-card rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden border border-primary/30 shadow-[0_0_50px_rgba(244,185,66,0.15)]"
          data-aos="zoom-in"
        >
          ...
          <div className="mt-12 flex justify-center items-center gap-8 text-sm font-medium text-gray-400">
