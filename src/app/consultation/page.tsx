    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100 p-8">
        <div className="text-center mb-10">
          <div className="w-16 h-16 mx-auto bg-[#baf2e9]/20 text-[#1e293b] rounded-2xl flex items-center justify-center mb-6 shadow-inner">
        ...
        <form onSubmit={handleInitialize} className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full bg-[#f8fafc] border border-gray-200 text-[#1e293b] rounded-xl p-4 focus:outline-none focus:ring-2 focus:ring-[#baf2e9]/50 transition-all shadow-inner"
              value={clientName}
